...
public class FocusHorizontalScrollView extends HorizontalScrollView
{
    ...
    public FocusHorizontalScrollView(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    protected int computeScrollDeltaToGetChildRectOnScreen(Rect rect)
    {
        ...
        /* 提前滚动的距离 */
        int fadingEdge = this.getResources().getDimensionPixelSize(R.dimen.x240);
    ...
    /*
     * boolean NeedsPage=false; int mydirection=-1;
     */
    @Override
    public void scrollTo(int x, int y)
    {
        super.scrollTo(x, y);
        /*
         * if(NeedsPage&&mydirection!=-1){ NeedsPage = false; pageScroll(mydirection); return; }
         */
