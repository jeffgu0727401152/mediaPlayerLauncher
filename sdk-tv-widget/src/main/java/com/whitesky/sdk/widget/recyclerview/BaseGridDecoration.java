...
/**
 * 当方向为水平方向的时候 除了第一行的下边间隙正常，其他行的下边间隙是interval的两倍 这是系统源码的bug
 */
public class BaseGridDecoration extends RecyclerView.ItemDecoration
{
    ...
    private void drawHBottom(RecyclerView parent, Canvas c)
    {
        ...
        for (int i = 0; i < parent.getChildCount(); i++)
        {
            ...
            mDivider.setBounds(view.getLeft() - interval, view.getBottom(), view.getRight(), view.getBottom() + 2
                * interval);
            mDivider.draw(c);
        }
    ...
    private void drawHRight(RecyclerView parent, Canvas c)
    {
        ...
        {
            View view = parent.getChildAt(i);
            mDivider.setBounds(view.getRight(), view.getTop(), view.getRight() + interval, view.getBottom() + 2
                * interval);
            mDivider.draw(c);
        }
    ...
    private void drawHTop(RecyclerView parent, Canvas c)
    {
        for (int i = 0; i < parent.getChildCount(); i++)
        {
            ...
            if (i % spanCount == 0)
            {
                mDivider.setBounds(view.getLeft() - interval,
                    view.getTop() - interval,
                    view.getRight() + interval,
                    view.getTop());
                mDivider.draw(c);
            }
        ...
        for (int i = 1; i < parent.getChildCount(); i++)
        {
            ...
            if (i % spanCount == 0)
            {
                ...
                if (i == parent.getChildCount() - 1)
                {
                    ...
                    View v = parent.getChildAt(i);
                    mDivider2.setBounds(v.getLeft(),
                        v.getBottom(),
                        parent.getChildAt(end).getLeft() - interval,
                        v.getBottom() + interval);
                    mDivider2.draw(c);
                }
                ...
                mDivider.setBounds(view.getLeft() - interval,
                    view.getBottom(),
                    parent.getRight() - interval,
                    view.getBottom() + interval);
            }
            ...
            else
            {
                ...
                if (op == 0)
                {
                    ...
                    mDivider2.setBounds(view1.getLeft(),
                        view1.getBottom(),
                        parent.getRight() - interval,
                        parent.getBottom());
                }
                else
                {
                    ...
                    mDivider2.setBounds(view1.getLeft(),
                        view1.getBottom(),
                        parent.getChildAt(endRight).getLeft(),
                        view1.getBottom() + interval);
        ...
        for (int i = 1; i < parent.getChildCount(); i++)
        {
            ...
            if (i % spanCount == 0)
            {
                ...
                if (i == parent.getChildCount() - 1)
                {
                    ...
                    mDivider2.setBounds(v.getLeft() - interval, v.getBottom() + interval, v.getLeft(), view.getBottom()
                        + interval);
                    mDivider2.draw(c);
                }
                rightEndIndex = i;
                mDivider.setBounds(parent.getRight() - interval,
                    parent.getChildAt(i - 1).getTop(),
                    parent.getRight(),
                    parent.getChildAt(i - 1).getBottom() + interval);
            ...
            else
            {
                ...
                else
                {
                    ...
                    mDivider2.setBounds(parent.getChildAt(rightEndIndex).getLeft() - interval,
                        top,
                        parent.getChildAt(rightEndIndex).getLeft(),
                        bottom);
    ...
    private void drawStartLeft(RecyclerView parent, Canvas c)
    {
        ...
        for (int i = 0; i < parent.getChildCount(); i++)
        {
            ...
            if (i % spanCount == 0)
            {
                mDivider.setBounds(view.getLeft() - interval, view.getTop(), view.getLeft(), view.getBottom()
                    + interval);
                mDivider.draw(c);
            }
