package com.whitesky.sdk.widget.focus;
...
/**
 * Created by xiaoxuan on 2017/7/20.
 */
public abstract class AbsFocusBorder extends View implements FocusBorder, ViewTreeObserver.OnGlobalFocusChangeListener
{
    ...
    private void setShimmerAnimating(boolean shimmerAnimating)
    {
        ...
        if (mShimmerAnimating)
        {
            mShimmerLinearGradient =
                new LinearGradient(0, 0, mFrameRectF.width(), mFrameRectF.height(), new int[] {0x00FFFFFF, 0x1AFFFFFF,
                    mShimmerColor, 0x1AFFFFFF, 0x00FFFFFF}, new float[] {0f, 0.2f, 0.5f, 0.8f, 1f},
    ...
    {
        /*
         * ViewGroup root = (ViewGroup) getParent(); Rect rect = new Rect(); root.offsetDescendantRectToMyCoords(view,
         * rect);
         */
    ...
    protected Rect findOffsetDescendantRectToMyCoords(View descendant)
    {
        ...
        // search and offset up to the parentA
