    ...
    public final static class Builder extends AbsFocusBorder.Builder
    {
        ...
        public FocusBorder build(ViewGroup parent)
        {
            ...
            final Drawable drawable =
                null != mBorderDrawable ? mBorderDrawable : Build.VERSION.SDK_INT >= 21 ? parent.getContext()
                    .getDrawable(mBorderResId) : parent.getContext().getResources().getDrawable(mBorderResId);
            final DrawableFocusBorder boriderView =
                new DrawableFocusBorder(parent.getContext(), mShimmerColor, mShimmerDuration, mIsShimmerAnim,
