...
public class TvLoadingView extends FrameLayout
{
    // 画笔
    private Paint paint;
    ...
    // 要输入的文本
    private String printText = "正在升级中，请勿进行任何操作，请勿断开电源！！！";
    ...
    public void calc()
    {
        ...
        path.reset();
        // 由于画文字是由基准线开始
        path.moveTo(iv.getX() - textWidth / 2 + iv.getWidth() / 2,
        ...
        iv.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener()
        {
            ...
            public void onGlobalLayout()
            {
                ...
                if (!flagMeure)
                {
                    flagMeure = true;
                    // 由于画文字是由基准线开始
                    path.moveTo(iv.getX() - textWidth / 2 + iv.getWidth() / 2, textHeight + iv.getHeight() + downHeight
                        * iv.getHeight());
