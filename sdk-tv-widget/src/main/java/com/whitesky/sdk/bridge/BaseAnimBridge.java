...
public abstract class BaseAnimBridge implements IAnimBridge
{
    ...
    private MainUpView2 mMainUpView;
    ...
    public void flyWhiteBorder(final View focusView, float x, float y, float scaleX, float scaleY)
    {
        ...
        ObjectAnimator scaleXAnimator =
            ObjectAnimator.ofInt(new ScaleView(getMainUpView()), "width", oldWidth, (int)newWidth);
        ObjectAnimator scaleYAnimator =
            ObjectAnimator.ofInt(new ScaleView(getMainUpView()), "height", oldHeight, (int)newHeight);
        //
     ...
     */
    @Override
    public void setMainUpView(MainUpView2 view)
    {
     ...
     */
    @Override
    public MainUpView2 getMainUpView()
    {
